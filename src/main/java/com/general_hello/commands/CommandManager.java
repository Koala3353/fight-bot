...
import com.general_hello.commands.commands.ComplexCommands.*;
import com.general_hello.commands.commands.DefaultCommands.*;
import com.general_hello.commands.commands.ICommand;
import com.general_hello.commands.commands.SimpleCommands.*;
...
public class CommandManager {
    ...
    public CommandManager(EventWaiter waiter) {
        ...
        //Basic Commands
        addCommand(new CreateMonsterCommand());
        addCommand(new AddUserCommand());
        addCommand(new DeleteUserCommand());
        addCommand(new ViewMonsterCommand());

        //Complex Commands
        addCommand(new StartRaidCommand());
        addCommand(new JoinRaidCommand());
        addCommand(new UserProfileCommand());
        addCommand(new StartPracticeCommand());
        addCommand(new FightCommand());
        addCommand(new AddStoreItem());
        addCommand(new ItemShopCommand());
        addCommand(new ApplyItemCommand());
